      ...
      >
        ...
        >
          <img
            ...
            alt="Profile"
            className="rounded-2xl shadow-[0_0_30px_rgba(130,69,236,0.5)] w-72 h-72 md:w-96 md:h-96 object-cover"
            style={{ transform: transformStyle }}
          />
        </motion.div>
        ...
        <motion.div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start sm:justify-center">
            ...
            <button
              onClick={() => setShowContactForm(true)}
              className="px-6 py-3 border-2 border-[#8245ec] text-[#8245ec] rounded-full hover:bg-[#8245ec] hover:text-white"
            >
              Let's talk <BsBoxArrowUpRight className="inline ml-2" />
            </button>
          </div>
        </motion.div>
      </motion.section>
