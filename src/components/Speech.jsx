...
// const API = "http://localhost:4004/api/quote";
const API='https://portfolio12server.onrender.com/api/quote'
...
const SpeechWords = () => {
  ...
  return (
    <section
      id="inspiring-words"
      className="relative py-16 px-6 md:px-20 text-white z-10"
    >
      ...
      >
        ...
        <h2 className="text-4xl font-bold">
          Inspiring <span className="text-[#8245ec]">Words</span>
        </h2>

        <p className="text-gray-400 mt-4 text-lg font-semibold">
          Wisdom and motivation that guides my journey
        </p>
      ...
      >
        ...
        {quotes.map((quote) => (
          ...
          <motion.div
            ...
            whileHover={{
              y: -10,
              boxShadow: "0 15px 30px rgba(130, 69, 236, 0.3)"
            }}
            className="bg-[#0a0824] p-6 rounded-xl border border-[#8245ec]/30 hover:border-[#8245ec]/60 transition-all"
          >
            ...
            <motion.div variants={textVariants}>
              ...
              <div className="text-[#8245ec] text-5xl font-serif mb-4">
                "
              </div>
      ...
      <motion.div
        ...
        animate={{ opacity: 0.3 }}
        transition={{ delay: 0.5, duration: 1 }}
        className="absolute -bottom-20 left-10 w-40 h-40 bg-[#8245ec] rounded-full blur-3xl -z-10"
      />
      ...
      <motion.div
        ...
        animate={{ opacity: 0.3 }}
        transition={{ delay: 0.8, duration: 1 }}
        className="absolute -top-20 right-10 w-60 h-60 bg-[#8245ec] rounded-full blur-3xl -z-10"
      />
